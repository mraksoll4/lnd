...
### Preliminaries
  In order to work with [`lnd`](https://github.com/mraksoll4/lnd), the
...
```
go get -d github.com/mraksoll4/lnd
cd $GOPATH/src/github.com/mraksoll4/lnd
make && make install
```
...
repo](https://github.com/mraksoll4/btcd).
...
Github](https://github.com/mraksoll4/lnd/issues/20).
...
light client powered by [neutrino](https://github.com/mraksoll4/neutrino).
...
[here](https://github.com/mraksoll4/lnd/blob/master/sample-lnd.conf)
