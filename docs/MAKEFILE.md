...
`btcd`
------
Ensures that the [`github.com/mraksoll4/btcd`][btcd] repository is checked out
locally. Lastly, installs the version of 
[`github.com/mraksoll4/btcd`][btcd] specified in `Gopkg.toml`
...
`check`
-------
Installs the version of [`github.com/mraksoll4/btcd`][btcd] specified
...
`itest`
-------
Installs the version of [`github.com/mraksoll4/btcd`][btcd] specified in
...
[btcd]: https://github.com/mraksoll4/btcd (github.com/mraksoll4/btcd")
